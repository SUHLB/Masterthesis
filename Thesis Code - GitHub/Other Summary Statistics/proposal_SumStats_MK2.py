# -*- coding: utf-8 -*-
"""
Created on Wed Aug 25 10:57:57 2021
...
def sumstats(x,funda,T,M):
    ...
    The function in that the summary statistics of the simulated time series are\
        calculated. The here presented are the SumStats by Franke & Westerhoff and\
            own additions.
    ...
    #ysort = np.sort(np.abs(dx))   # sort the returns
    ...
    #autocorr_dp_pf[0,1],\
        #iota
    sumstat=[autocorr_dx[0,1],acf_1,acf_3,acf_6,acf_12,acf_24,acf_60,\
             dlx_mean,dlx_max,dlx_min,dlx_var,dlx_skew,dlx_kurtosis,dp_pf_mean,dp_pf_max,\
                 dp_pf_min,dp_pf_var,dp_pf_skew,dp_pf_kurtosis,autocorr_dp_pf[0,1],\
