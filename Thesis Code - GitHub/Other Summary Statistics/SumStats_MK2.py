...
def sumstats(x,funda,T,M):
    ...
    acf_dp_pf= statsm.acf(div, nlags=12)
    #one month
    ...
    #autocorr_dp_pf[0,1],\
    #Sumstats 14 long
    sumstat=[acf_1,acf_3,acf_6,acf_12,\
             dlx_mean,dlx_var,dlx_skew,dlx_kurt,\
                 dp_pf_var,dp_pf_skew,dp_pf_kurt,\
                     acf_dp_pf_1,acf_dp_pf_3,acf_dp_pf_6,acf_dp_pf_12]
